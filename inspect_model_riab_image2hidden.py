...
def main(args):
    ...
    options.image_loss_weight = args.image_loss_weight # weight of image loss
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--image_loss_weight', type=float, default=1e-2, help="Strength of image output loss")
